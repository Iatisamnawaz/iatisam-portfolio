const styles = {
  ...
  sectionHeadText:
    'text-palleteFour font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins',
  sectionHeadTextLight:
    'text-timberWolf font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins',
  sectionSubText:
    'sm:text-[18px] text-[16px] text-palleteThree uppercase tracking-wider font-semibold font-poppins',
  sectionSubTextLight:
